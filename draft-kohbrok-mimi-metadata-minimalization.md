...
The identity link wrapper key is distributed to new participants as they join
the room.
...
to which clients are required to provide identity link keys. For example,
identity link keys might not be allowed at all, or only admins are required to
provide identity link keys.
